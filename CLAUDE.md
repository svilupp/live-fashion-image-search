...
This is a **fashion image search application** built with React Router 7 and
Deno, featuring real-time camera-based visual search using CLIP embeddings.
...
- Stores quantized Int8 vectors with product metadata (id, image, title, price,
  description)
